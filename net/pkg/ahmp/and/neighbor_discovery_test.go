...
func (p *NeighborDiscoveryTestPeer) SendJN(path string) error {
	p.Log("AHMP/1.0 JN " + path)
	return nil
}
func (p *NeighborDiscoveryTestPeer) SendJOK(path string, w INeighborDiscoveryWorldBase, member_addrs []any) error {
...
func (p *NeighborDiscoveryTestPeer) SendJDN(path string, status int, msg string) error {
	p.Log("AHMP/1.0 JDN " + path + " " + strconv.Itoa(status) + " " + msg)
	return nil
}
func (p *NeighborDiscoveryTestPeer) SendJNI(w INeighborDiscoveryWorldBase, j INeighborDiscoveryPeerBase) error {
...
func (p *NeighborDiscoveryTestPeer) SendMEM(w INeighborDiscoveryWorldBase) error {
	p.Log("AHMP/1.0 MEM " + w.GetUUID())
	return nil
}
func (p *NeighborDiscoveryTestPeer) SendSNB(w INeighborDiscoveryWorldBase, i []string) error {
...
func (p *NeighborDiscoveryTestPeer) SendCRR(w INeighborDiscoveryWorldBase, i string) error {
...
func (p *NeighborDiscoveryTestPeer) SendRST(world_uuid string) error {
...
func TestOpenWorld(t *testing.T) {
	...
	ndh := local_host.ndh
	if nil != ndh.OpenWorld("/", NewWorld_Testimpl()) {
		t.Fail()
	}
	ndh.CloseWorld("/")
...
func TestJoin1(t *testing.T) {
	...
	ndh.OnJOK(join_target, "/target", join_world, []any{})
...
func TestMEM(t *testing.T) {
	...
	if nil != ndh.OpenWorld("/default", world) {
...
func TestPrematureJoin(t *testing.T) {
	...
	ndh.Connected(peer_target)
	ndh.OnJOK(peer_target, "/w", world, []any{})
